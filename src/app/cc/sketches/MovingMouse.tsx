...
export default function MovingMouse() {
    ...
    const sketch = (p: p5) => {
        ...
        p.draw = () => {
            ...
            let overlap = imgX < textX + textWidth &&
                imgX + imgWidth > textX &&
        ...
        function cable() {
            ...
            p.curve(
                -1000, 500,
                0, 0,
                p.mouseX + 100, p.mouseY,
                p.mouseX + 1000, p.mouseY - 200);
            p.pop()
        }
        ...
        const isOverlapping = (
            ...
            return !(x1 + w1 < x2 || // Text is to the left of image
                x1 > x2 + w2 || // Text is to the right of image
                y1 + h1 < y2 || // Text is above image
                y1 > y2 + h2);  // Text is below image
        };
    };
